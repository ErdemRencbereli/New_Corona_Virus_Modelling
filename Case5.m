...
delta_2 = 0/100; %percentage of isolated infected people at the initialization [0% 100%]
                 %We chose 0 since there is no isolation in this case
q_s = 0.0; %isolation probability of a newly infected person
...
%t_v =t_s,t_s+1,t_s+2, ...
%delta_3 = (1)/(k*(t_v-19));
t_sec = 10; %number of iterations between two vaccinations, 2 and 10 are selected
...
figure
tiledlayout(4,2)
sgtitle('Case 5: Impact of the Prevention of Vaccination Under a Double-Vaccination Policy, t-sec = 10 (N=300, ∆_1=8, ∆_2=0, k=2, p=0.4, M=10)');
nexttile
bar(xaxis,plot1)
