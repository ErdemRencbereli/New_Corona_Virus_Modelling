...
N = 300; %population = N; [120,500] We chose 300 for this case
delta_1 = 8/100;  %percentage of infected people initially - [1% - 15%] We chose 8 for this case.
index_person = 0; %Starting from the first person
p = 0.4; %infection probability in scenario of encounter [0.1 0.7], In this scenario, we chose 0.4
delta_2 = 50/100; %percentage of isolated infected people at the initialization [0% 100%], we chose 50
q_s = 0.5; %isolation probability of a newly infected person - constant
...
vaccinated_people_iterations = zeros(2,x);
...
for index_iter = 1:x
    ...
    if index_iter >= t_s
        ...
        delta_3 = (1)/(k*(t_v-19));
        for vac_index = 1:N
            if information(1,vac_index) == 1 || information(1,vac_index) == 4 
...
figure
tiledlayout(4,2)
sgtitle('Case 3: Impact of the Vaccination Rate, k = 2 (N=300, ∆_1=8, ∆_2=0.5, p=0.4, M=10)');
nexttile
bar(xaxis,plot1)
