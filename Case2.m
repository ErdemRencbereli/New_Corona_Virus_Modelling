...
delta_2 = 100/100; %percentage of isolated infected people at the initialization, we 
                   %consider two cases delta_2 = 0 or 100
...
figure
tiledlayout(3,2)
sgtitle('Performance Criterias for N=300, delta_1 = 0.1, delta_2 = 1');
nexttile
bar(xaxis,plot1)
