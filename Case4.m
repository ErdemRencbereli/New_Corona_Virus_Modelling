...
p = 0.2; %infection probability in scenario of encounter [0.1 0.7], In this scenario, we 
         %
...
figure
tiledlayout(3,2)
sgtitle('Case 4: The Impact of Contagiousness On the Spread of the Pandemic, p=0.6');
nexttile
bar(xaxis,plot1)
